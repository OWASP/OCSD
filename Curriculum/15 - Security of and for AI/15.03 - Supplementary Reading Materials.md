...
The [Input Threats section of the OWASP AI Exchange](https://owaspai.org/docs/2_threats_through_use/#rate-limit) highlights how limiting the rate of access to the model - preferably per actor (user, API key or session) may not only prevent resource exhaustion but also severely slow down experimentation that underlies many AI attacks through use. You can also find relevant information from [OpenCRE](https://opencre.org/cre/187-083) and [MITRE Atlas](https://atlas.mitre.org/mitigations/AML.M0004).

### Supply Chain Risks for AI Models

Further information about supply chain security for AI models can be found in [Chapter 6](https://github.com/OWASP/AISVS/blob/main/1.0/en/0x10-C06-Supply-Chain.md) of the OWASP Artificial Intelligence Security Verification Standard.

### Vector and Embedding Weaknesses

[Chapter 8](https://github.com/OWASP/AISVS/blob/main/1.0/en/0x10-C08-Memory-Embeddings-and-Vector-Database.md) of the OWASP Artificial Intelligence Security Verification Standard reviews relevant security controls for memory embeddings and vector databases. 
...
You can find further guidance on this subject in [Chapter 1 (Training Data Integrity & Traceability) of the OWASP Artificial Intelligence Security Verification Standard (AISVS) project](https://github.com/OWASP/AISVS/blob/main/1.0/en/0x10-C01-Training-Data-Integrity-and-Traceability.md), which is a catalog of testable security requirements for AI-enabled systems that may be useful for developers, as well as architects, security engineers and auditors.
